...
var ovc = L.tileLayer.wms('http://ovc.catastro.meh.es/Cartografia/WMS/ServidorWMS.aspx', {
    maxZoom: maxZoom,
	layers: 'Catastro',
	format: 'image/png',
	transparent: false,
...
var orto5657 = L.tileLayer.wms("http://www.juntadeandalucia.es/medioambiente/mapwms/REDIAM_Ortofoto_Andalucia_1956?", {
    maxZoom: maxZoom,
    layers: 'ortofoto_1956',
    format: 'image/png',
    transparent: true,
    attribution: '<a href="http://www.juntadeandalucia.es/institutodeestadisticaycartografia" target="_blank">IECA REDIAM</a>'
});

var orto7783 = L.tileLayer.wms("http://www.juntadeandalucia.es/medioambiente/mapwms/REDIAM_Ortofoto_BN_1977_83?", {
    maxZoom: maxZoom,
