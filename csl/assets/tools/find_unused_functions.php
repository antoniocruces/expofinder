...
// For use on PHP-CLI: #!/usr/bin/php -f as the very first line of the file, before PHP tag
...
$root_dir = '/var/www/html/admin.expofinder.es/public_html/wp-content/themes/csl';
