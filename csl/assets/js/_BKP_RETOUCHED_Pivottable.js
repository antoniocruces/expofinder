/**
 * Pivot Table. Based in a work of Nicolas Kruchten (http://nicolas.kruchten.com/pivottable)
 */
(function() {
	var callWithJQuery, indexOf = [].indexOf ||
	function(item) {
	...
	callWithJQuery(function($) {
		...
		$.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
			...
			try {
				...
				rendererControl = $("<td>").addClass('pvtVals');
				...
				tr1 = $("<tr class\"tr1\">").appendTo(uiTable);
