...
class Readability
{
	...
	**/
	public $regexps = array(
		'unlikelyCandidates' => '/combx|comment|community|disqus|extra|foot|header|menu|remark|rss|shoutbox|sidebar|publicidad|footer|header|anunciantes|comercios|sponsor|ad-break|agegate|pagination|pager|popup/i',
		'okMaybeItsACandidate' => '/and|article|body|column|main|envoltura|contDcha|shadow/i',
		'positive' => '/article|body|content|entry|hentry|main|page|attachment|pagination|post|text|contDcha|blog|elementoListado|story/i',
		'negative' => '/combx|comment|com-|contact|foot|footer|_nav|footnote|masthead|media|meta|outbrain|publicidad|footer|header|anunciantes|comercios|promo|related|scroll|shoutbox|sidebar|sponsor|shopping|tags|tool|widget/i',
